...
struct HEAVYLIGHT_DECOMPOSITION {
        ...
        inline void UpdateUP( int u , int v , int w ) {
                if( u == v ) {
        ...
        inline void UpdateHLD( int u , int v , int w ) {
                int lca = LCA( u , v );
                UpdateUP( u , lca , w );
                UpdateUP( v , lca , w );
                UpdateUP( lca , lca , -w );
        }
        inline int QueryHLD( int u , int v ) {
                int lca = LCA( u , v );
                int x = QueryUP( u , lca );
                int y = QueryUP( v , lca );
                int z = QueryUP( lca , lca );
                return ( x + y - z );
        }
