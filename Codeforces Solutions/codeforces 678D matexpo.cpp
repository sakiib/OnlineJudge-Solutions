...
int main( int argc , char const *argv[] ) {
    ...
    LL a , b , n , x;
    sc("%lld %lld %lld %lld",&a,&b,&n,&x);
    original.M[1][1] = a , original.M[1][2] = b;
    original.M[2][1] = 0 , original.M[2][2] = 1;
    Matrix res = MatrixExpo( original , n );
    pf("%lld\n",(res.M[1][1]%MOD+res.M[1][2]%MOD)%MOD);
    return 0;
}
